...
const aboutcompany_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "aboutcompany.html.vue"]]);
const data = JSON.parse('{"path":"/docs/others/aboutcompany.html","title":"案例","lang":"en-US","frontmatter":{"title":"案例","isShowComments":false},"headers":[],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"filePathRelative":"docs/others/aboutcompany.md"}');
export {
  aboutcompany_html as comp,
  data
};
