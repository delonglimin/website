...
var n, r, o, i, a, c, u, l, s, f, p, m, v = {}, h = [], d = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, y = Array.isArray;
function _(e2, t2) {
...
var K, W, z, J, Q = 0, $ = [], Z = r, G = Z.__b, Y = Z.__r, X = Z.diffed, ee = Z.__c, te = Z.unmount, ne = Z.__;
function re(e2, t2) {
...
var Ae = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.forward_ref") || 3911, Ne = function(e2, t2) {
  return null == e2 ? null : C(C(e2).map(t2));
}, Te = { map: Ne, forEach: Ne, count: function(e2) {
...
var rt, ot = { enumerable: false, configurable: true, get: function() {
  return this.class;
} }, it = r.vnode;
r.vnode = function(e2) {
...
var Nt = ["translations"], Tt = "Ctrl", Rt = st.forwardRef(function(e2, t2) {
...
var Vt = function() {
}, Kt = [{ segment: "autocomplete-core", version: "1.17.9" }];
function Wt(e2) {
...
var pn = "2.15.0", mn = "https://cdn.jsdelivr.net/npm/search-insights@".concat(pn, "/dist/search-insights.min.js"), vn = qt(function(e2) {
...
var ir, ar, cr, ur = null, lr = (ir = -1, ar = -1, cr = void 0, function(e2) {
  var t2 = ++ir;
...
var yr = ["props", "refresh", "store"], _r = ["inputElement", "formElement", "panelElement"], gr = ["inputElement"], br = ["inputElement", "maxLength"], Sr = ["source"], Or = ["item", "source"];
function wr(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
var yo = /(<mark>|<\/mark>)/g, _o = RegExp(yo.source);
function go(e2) {
  var t2, n2, r2 = e2;
...
var wo = ["translations"], Eo = st.memo(function(e2) {
...
var Qo = ["appId", "apiKey", "authMode", "algoliaAgents"], $o = ["params"], Zo = "5.19.0";
function Go(e2) {
